...
export interface TokenInterface extends utils.Interface {
  ...
  events: {
    ...
    "Transfer(address)": EventFragment;
    "Transfer(address,address,uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "Approval"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Transfer(address)"): EventFragment;
  getEvent(
...
export interface Transfer_address_EventObject {
  to: string;
}
export type Transfer_address_Event = TypedEvent<
  [string],
  Transfer_address_EventObject
>;

export type Transfer_address_EventFilter =
  TypedEventFilter<Transfer_address_Event>;
...
export interface Token extends BaseContract {
  ...
  filters: {
    ...
    "Transfer(address)"(to?: null): Transfer_address_EventFilter;
